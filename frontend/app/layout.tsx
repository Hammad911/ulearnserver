      ...
      <body className={`${inter.className} overflow-x-hidden`}>
        <div className="min-h-screen flex flex-col bg-[linear-gradient(135deg,_#e0f2fe_0%,_#f0f9ff_20%,_#ffe4e6_40%,_#bae6fd_60%,_#a5f3fc_100%)]">
          ...
          <div className="flex flex-1 relative">
            ...
            <main className={`transition-all duration-300 ease-in-out ${isNavOpen ? 'pt-48' : 'pt-16'} md:pt-16 flex-1 pb-20 ${isSidebarCollapsed ? '' : ''} md:${isSidebarCollapsed ? 'ml-24' : 'ml-64'} ml-0`}>
              {children}
              <Footer />
            </main>
          </div>
