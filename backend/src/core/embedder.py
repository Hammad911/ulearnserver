...
if not PINECONE_API_KEY or not GOOGLE_API_KEY or not PINECONE_ENVIRONMENT:
    raise ValueError("Please set PINECONE_API_KEY, GOOGLE_API_KEY, and PINECONE_ENVIRONMENT in your .env file")
